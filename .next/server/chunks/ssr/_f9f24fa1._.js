...
const TT2025 = ()=>{
    ...
    const [productName, setProductName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])("");
    const [productType, setProductType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])("");
    const [productCode, setProductCode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        fetch("http://localhost:3001/tt2025").then((res)=>res.json()).then((data)=>setData(data)).catch(console.error);
    }, []);
    const handleInsert = async (e)=>{
        ...
        const res = await fetch("http://localhost:3001/tt2025", {
            method: "POST",
            headers: {
    ...
    const handleUpdate = async ()=>{
        if (!selectedItem) return alert("กรุณาเลือกสินค้าที่ต้องการแก้ไข");
        const body = {
            name: productName,
            product_type: productType,
            product_code: productCode
        };
        await fetch(`http://localhost:3001/tt2025/${selectedItem.id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const handleDelete = async ()=>{
        if (!selectedItem) return alert("กรุณาเลือกสินค้าที่ต้องการลบ");
        await fetch(`http://localhost:3001/tt2025/${selectedItem.id}`, {
            method: "DELETE"
        });
...
const __TURBOPACK__default__export__ = TT2025;
}}),
